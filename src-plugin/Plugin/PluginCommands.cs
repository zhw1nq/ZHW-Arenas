namespace ZHWArenas
{
	...
	public sealed partial class Plugin : BasePlugin
	{
		...
		public void Command_Accept(CCSPlayerController? player, CommandInfo info)
		{
			...
			{
				info.ReplyToCommand($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.general.challenge.notchallenged"]}");
				return;
			}
			...
			if (!p2.IsValid)
			{
				info.ReplyToCommand($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.general.challenge.notavailable"]}");
				p1.Challenge = null;
				return;
			}
			...
			info.ReplyToCommand($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.general.challenge.accepted", p2.Controller.PlayerName]}");
			p2.Controller.PrintToChat($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.general.challenge.acceptedby", player!.PlayerName]}");
		}
		...
		public void Command_Decline(CCSPlayerController? player, CommandInfo info)
		{
			...
			info.ReplyToCommand($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.general.challenge.declined", p2.Controller.PlayerName]}");
			p2.Controller.PrintToChat($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.general.challenge.declinedby", player!.PlayerName]}");
		}
		...
		public void Command_Challenge(CCSPlayerController? player, CommandInfo info)
		{
			...
			{
				info.ReplyToCommand($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.general.challenge.inchallenge"]}");
				return;
			}
			...
			{
				info.ReplyToCommand($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.general.challenge.invalidtarget"]}");
				return;
			}
			...
			{
				info.ReplyToCommand($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.general.challenge.notinarena"]}");
				return;
			}
			...
			info.ReplyToCommand($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.general.challenge.waiting", challengedPlayer.PlayerName]}");
			challengedPlayer.PrintToChat($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.general.challenge.request", player!.PlayerName, Config.CommandSettings.ChallengeAcceptCommands.FirstOrDefault("Missing"), Config.CommandSettings.ChallengeDeclineCommands.FirstOrDefault("Missing")]}");
		}
		...
		public void Command_AFK(CCSPlayerController? player, CommandInfo info)
		{
			...
			info.ReplyToCommand($" {Localizer["zhw.general.prefix"]} {(arenaPlayer.AFK ? string.Format(Localizer["zhw.chat.afk_enabled"], Config.CommandSettings.AFKCommands.FirstOrDefault("Missing")) : Localizer["zhw.chat.afk_disabled"])}");
		}
		...
		public void Command_Queue(CCSPlayerController? player, CommandInfo info)
		{
			...
			if (queuePlace == -1)
			{
				info.ReplyToCommand($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.chat.queue_not_in_queue"]}");
				return;
			}

			info.ReplyToCommand($" {Localizer["zhw.general.prefix"]} {Localizer["zhw.chat.queue_position", queuePlace + 1]}");
		}
